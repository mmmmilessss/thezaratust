...
export default function MediaCursor() {
  ...
  return <div ref={ref} aria-hidden className={`pointer-events-none fixed left-0 top-0 z-[100] bg-white px-1.5 py-1 text-[8px] tracking-[0.08em] text-black transition-opacity ${label ? "opacity-100" : "opacity-0"}`}>{label}</div>;
}
